...
- [`10-ble.md`](10-ble.md): experimental BLE profile label, candidate GATT service/advertisement and token lifecycle; handshake, framing, and interoperability remain open.
